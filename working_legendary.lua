...
pcall(function() if G:FindFirstChild("L") then G.L:Destroy() end end)
local S,F,B,TL=Instance.new("ScreenGui"),Instance.new("Frame"),Instance.new("TextButton"),Instance.new("TextLabel")
S.Name="L";S.Parent=G;F.Parent=S;F.Size=UDim2.new(0,150,0,50);F.Position=UDim2.new(0,50,0.4,0);F.Active=true;F.Draggable=true;F.BackgroundColor3=Color3.fromRGB(150,100,0)
B.Parent=F;B.Size=UDim2.new(1,-10,0,30);B.Position=UDim2.new(0,5,0,5);B.Text="LEG+: ON";B.BackgroundColor3=Color3.new(1,0.8,0);B.TextColor3=Color3.new(0,0,0)
...
B.MouseButton1Click:Connect(function() ON=not ON;B.Text=ON and "LEG+: ON" or "OFF";B.BackgroundColor3=ON and Color3.new(1,0.8,0) or Color3.new(0.5,0,0) end)
