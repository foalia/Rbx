...
local MIN,lastAFK,AFKi,lastWH=9,tick(),math.random(30,60),""
...
if BD<6 then H:MoveTo(R.Position);TL.Text="BUY..";V:SendKeyEvent(true,Enum.KeyCode.E,false,game);wait(HD);V:SendKeyEvent(false,Enum.KeyCode.E,false,game);wait(0.5);if not BT or not BT.Parent then TL.Text="OK!";sendWH("SECRET: "..BN.." ["..BRN.."]") end end
