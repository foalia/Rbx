...
if BD<6 then IT=IT+1;if IT>25 then H:MoveTo(R.Position-R.CFrame.LookVector*8);IT=0;wait(0.5);return end;H:MoveTo(R.Position);V:SendKeyEvent(true,Enum.KeyCode.E,false,game);wait(HD);V:SendKeyEvent(false,Enum.KeyCode.E,false,game);if BT then IG[BT]=tick();sendWH("SECRET FOUND: "..BN.." ["..BRN.."]") end;TL.Text="OK!";wait(0.2) else IT=0 end
