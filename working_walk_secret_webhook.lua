...
local MIN,lastAFK,AFKi,lastBuy=9,tick(),math.random(30,60),nil
...
if BD<6 and BT~=lastBuy then H:MoveTo(R.Position);TL.Text="BUY..";V:SendKeyEvent(true,Enum.KeyCode.E,false,game);wait(HD);V:SendKeyEvent(false,Enum.KeyCode.E,false,game);lastBuy=BT;wait(0.5);if not BT or not BT.Parent then TL.Text="OK!";sendWH("SECRET: "..BN.." ["..BRN.."]");lastBuy=nil end end
else TL.Text="...";SC=0;lastBuy=nil end end) end end end)
